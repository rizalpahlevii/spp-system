<nav class="navbar navbar-expand-lg bg-white fixed-top">
    <a class="navbar-brand" href="{{route('siswa.dashboard')}}">E-SPP SYSTEM</a>
            ...
            <li class="nav-item dropdown nav-user">
                ...
                <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                    <div class="nav-user-info">
                        <h5 class="mb-0 text-white nav-user-name">{{Auth::guard('siswa')->user()->name}}</h5>
                        <span class="status"></span><span class="ml-2">Online</span>
                    </div>
                    <a class="dropdown-item" href="{{route('siswa.profile')}}"><i class="fas fa-user mr-2"></i>Account</a>
                    <a class="dropdown-item" href="{{route('siswa.change_password')}}"><i class="fas fa-cog mr-2"></i>Change Password</a>
